...
str="  javaCAn'lara selam olsun :) java ile 1234555544 offer ***   ";
        System.out.println(str.replaceAll("\\s", "+"));//++javaCAn'lara+selam+olsun+:)+java+ile+1234555544+offer+***+++
        System.out.println(str.replaceAll("\\S", "+"));// ++++++++++++ +++++ +++++ ++ ++++ +++ ++++++++++ +++++ +++
        System.out.println(str.replaceAll("\\w", "+"));// +++++++'++++ +++++ +++++ :) ++++ +++ ++++++++++ +++++ ***
        System.out.println(str.replaceAll("\\W", "+"));//++javaCAn+lara+selam+olsun++++java+ile+1234555544+offer+++++++
        System.out.println(str.replaceAll("\\d", "+"));//javaCAn'lara selam olsun :) java ile ++++++++++ offer ***
        System.out.println(str.replaceAll("\\D", "+"));//+++++++++++++++++++++++++++++++++++++++1234555544+++++++++++++
...
//
       ...
       String isim="Merve";
       String soyad="TC";
     String kartNo="1234456467979997";
      ...
      String yeniKart= "**** **** ****"+kartNo.substring(12);
        System.out.println("isim-soyisim " + yeniİsim +" "+ yeniSoyad + " kart no "+ yeniKart);
